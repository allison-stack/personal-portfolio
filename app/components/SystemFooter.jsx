...
export function SystemFooter() {
  ...
  return (
    <div className="border-t dashline px-1 py-2 flex items-center justify-between text-[10.5px] muted tabular-nums">
      <span>
        <span className="accent">⏵⏵ accept edits on</span> · build <span className="strong">v2026.05</span> · cwd <span className="strong">{pretty(cwd)}</span> · session <span className="strong">{session}</span>
      </span>
