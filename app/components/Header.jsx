  ...
  return (
    <div id="home" className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
            ...
            <a href="app/assets/Allison_Zhao's_Resume.pdf" download className="px-8 py-3 border rounded-full flex items-center gap-2 transition-all duration-200 hover:opacity-80 hover-lift" style={{borderColor: 'var(--border-primary)', color: 'var(--text-primary)'}}>my resume</a>
        </div>
    </div>
  )
}
